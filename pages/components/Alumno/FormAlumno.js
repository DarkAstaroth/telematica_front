...
import { alumnoPost } from "../../../controllers/alumnoController";
...
const FormAlumno = () => {
  ...
  const { alumnoGet, alumnoPost, mensaje, alumnos } = alumnosContext;
  ...
  function onSubmit(model) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        alumnoPost(model);
        alumnoGet();
        Swal.fire("Buen trabajo!", "Asignatura creada con exito!", "success");
      }
    });
  }
  return (
