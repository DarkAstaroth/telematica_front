...
const FormAsignarutaPut = ({ data }) => {
  const asignaturasContext = useContext(asignaturaContext);
  const { asignaturaGet, asignaturaPut, asignaturas } = asignaturasContext;
...
export default FormAsignarutaPut;
